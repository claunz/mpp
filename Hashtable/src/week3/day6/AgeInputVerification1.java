...
class AgeInputVerification1 {
	private static final String DEFAULT_MESSAGE = "Your age:";

	public AgeInputVerification1() {
	}
	...
	public int getAge(String prompt) {
		...
		while (true) {
			...
			try {
				...
				JOptionPane.showMessageDialog(null,"Wow, how about that");
	...
	public static void main(String[] args) {
		AgeInputVerification1 ag = new AgeInputVerification1();
//		int age = ag.getAge("Please type in your age");
		ag.getAge("Please type in your age");
	}
}
